...
import { Token } from '@jpatcharapun/stargb-sdk'
          ...
          <Box>
            <MessageText display="inline">
              {publicIfoData.status === 'finished'
                ? t('Activate StarGB Profile to take part in next IFO‘s!')
                : t('You need an active StarGB Profile to take part in an IFO!')}
            </MessageText>{' '}
